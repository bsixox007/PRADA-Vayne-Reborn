        ...
        public static void ConstructMenu()
        {
            ...
            Program.ComboMenu.AddItem(
                new MenuItem("QMode", "Q Mode: ").SetValue(
                    new StringList(new[] { "PRADA", "TO MOUSE" }))).SetFontStyle(FontStyle.Bold, Color.Red);
            Program.ComboMenu.AddItem(
            ...
            Program.LaneClearMenu.AddItem(
                    new MenuItem("EJungleMobs", "Use E on Jungle Mobs").SetValue(true))
                .SetFontStyle(FontStyle.Bold, Color.Red);
            ...
            Program.SkinhackMenu.AddItem(
                    new MenuItem("skin", "Skin: ").SetValue(
                        new StringList(
                            new[]
                            {
                                    "Classic", "Vindicator", "Aristocrat", "Dragonslayer", "Heartseeker", "SKT T1",
                                    "Arclight", "Dragonslayer Green", "Dragonslayer Red", "Dragonslayer Azure",
                                    "Soulstealer"
                            }, 10))).SetFontStyle(FontStyle.Bold, Color.Gold).ValueChanged +=
                (sender, args) => { Utility.DelayAction.Add(250, SkinHack.RefreshSkin); };
        }
