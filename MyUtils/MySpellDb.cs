...
namespace PRADA_Vayne.Utils
{
    public static class SpellDb
    {
        ...
        static SpellDb()
        {
            Spells = new List<TargetSpellData>
            {
                ...
                new TargetSpellData("aatrox", "aatroxq", SpellSlot.Q, SpellType.Skillshot, CcType.Knockup, 650, 500,
                    2000, true),
                ...
                new TargetSpellData("aatrox", "aatroxe", SpellSlot.E, SpellType.Skillshot, CcType.Stun, 1075, 250,
                    1250),
                new TargetSpellData("aatrox", "aatroxr", SpellSlot.R, SpellType.Self, CcType.No, 550, 0, 0, false,
                    false, true),
                ...
                new TargetSpellData("akali", "akalishadowswipe", SpellSlot.E, SpellType.Self, CcType.No, 325, 0,
                    int.MaxValue),
                new TargetSpellData("akali", "akalishadowdance", SpellSlot.R, SpellType.Targeted, CcType.No, 800, 250,
                    2200),
                ...
                new TargetSpellData("mordekaiser", "mordekaisercreepindeathcast", SpellSlot.W, SpellType.Targeted,
                    CcType.No, 750, 500, int.MaxValue),
                ...
                new TargetSpellData("pantheon", "pantheonq", SpellSlot.Q, SpellType.Targeted, CcType.No, 600, 500,
                    1500),
                new TargetSpellData("pantheon", "pantheonw", SpellSlot.W, SpellType.Targeted, CcType.Stun, 600, 500,
                    int.MaxValue),
                new TargetSpellData("pantheon", "pantheone", SpellSlot.E, SpellType.Skillshot, CcType.No, 600, 500,
                    775),
                new TargetSpellData("pantheon", "pantheonrjump", SpellSlot.R, SpellType.Skillshot, CcType.No, 5500,
                    1000, 3000, false, false, true),
    ...
    public class TargetSpell
    {
        ...
        public int EndTick => (int)(StartTick + Spell.Delay + 1000 * (StartPosition.Distance(EndPosition) / Spell.Speed));
